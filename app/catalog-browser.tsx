...
const copy = {
  zh: {
    ...
    methodCards: [
      ...
      ["04", "實體書完整保留", "可依專案需求代為保管買斷後的實體書籍；數位化完成後仍維持書本完整，兼顧 AI 應用與文化保存。", "BOOKS REMAIN BOOKS"],
    ],
    inquiryKicker: "ENTERPRISE INQUIRY 04", inquiryTitle: "把紙本藏書轉化為可用的 AI 語料。",
    inquiryDesc: "我們提供整批實體書籍買斷與代為保管服務，並歡迎 AI 公司、資料服務商、研究單位及文化保存機構洽談盤點去重、批量數位化、資料製作與專案出資。",
    models: ["整批實體書籍買斷", "專案書籍代為保管", "客製化大批量數位化", "新台幣／美元專案出資", "參考加工模式：每冊固定價格，依規格另議"],
  ...
  en: {
    ...
    methodCards: [
      ...
      ["04", "Books remain books", "We can provide custodial storage for purchased physical books. After digitization, every volume remains intact, aligning AI use with cultural preservation.", "BOOKS REMAIN BOOKS"],
    ],
    inquiryKicker: "ENTERPRISE INQUIRY 04", inquiryTitle: "Turn a paper collection into usable AI data.",
    inquiryDesc: "We provide outright purchase and custodial storage services for physical book collections. AI companies, data providers, researchers, and cultural institutions are welcome to discuss inventory deduplication, bulk digitization, data production, and project funding.",
    models: ["Outright purchase of physical book collections", "Custodial storage for project books", "Custom high-volume digitization", "Project funding in TWD or USD", "Reference processing model: fixed per-volume pricing, subject to specification"],
