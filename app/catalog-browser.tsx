...
export default function CatalogBrowser() {
  ...
  function loadOfficialCatalog() {
    ...
    Promise.all([
      fetch("/official-search-compact-1.json?v=stock-113254-images-20260812").then((response) => response.json()),
      fetch("/official-search-compact-2.json?v=stock-113254-images-20260812").then((response) => response.json()),
    ])
