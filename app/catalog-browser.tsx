...
const copy = {
  zh: {
    ...
    inquiryDesc: "歡迎 AI 公司、資料服務商、研究單位及文化保存機構洽談盤點去重、批量數位化、資料製作與專案出資。",
    models: ["客製化大批量數位化", "資料授權合作方案", "新台幣／美元專案出資", "參考加工模式：每冊固定價格，依規格另議"],
  ...
  en: {
    ...
    inquiryDesc: "We welcome AI companies, data providers, researchers, and cultural institutions to discuss inventory deduplication, bulk digitization, data production, and project funding.",
    models: ["Custom high-volume digitization", "Data licensing partnership plans", "Project funding in TWD or USD", "Reference processing model: fixed per-volume pricing, subject to specification"],
