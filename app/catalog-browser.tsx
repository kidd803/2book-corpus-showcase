...
const copy = {
  zh: {
    ...
    models: ["客製化大批量數位化", "依權利狀態規劃資料授權", "新台幣／美元專案出資", "參考加工模式：每冊固定價格，依規格另議"],
  ...
  en: {
    ...
    models: ["Custom high-volume digitization", "Rights-aware data licensing plans", "Project funding in TWD or USD", "Reference processing model: fixed per-volume pricing, subject to specification"],
